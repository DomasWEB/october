...
return [
    ...
    'dashboard' => [
        'active_theme' => [
            ...
            'customize_theme' => 'Personalizuoti temą'
        ]
    ],
    'theme' => [
    ...
    'theme_log' => [
        'hint' => 'Šis išrašas rodo bet kokius pakeitimus atliktus administratorių temai valdymo sistemoje.',
        'menu_label' => 'Temos išrašas',
        'menu_description' => 'Parodyti pakeitimus atliktus aktyviai temai.',
        'empty_link' => 'Išvalyti temos išrašus',
        'empty_loading' => 'Išvalomas temos išrašas...',
        'empty_success' => 'Temos išrašas išvalytas',
        'return_link' => 'Grįžti į temos išrašą',
        'id' => 'ID',
        'id_label' => 'Išrašo ID',
        ...
        'type' => 'Tipas',
        'type_create' => 'Sukurti',
        'type_update' => 'Atnaujinti',
        'type_delete' => 'Ištrinti',
        'theme_name' => 'Tema',
        'theme_code' => 'Temos kodas',
        'old_template' => 'Šablonas (senas)',
        'new_template' => 'Šablonas (naujas)',
        'template' => 'Šablonas',
        'diff' => 'Pasikeitimai',
        'old_value' => 'Sena reikšmė',
        'new_value' => 'Nauja reikšmė',
        'preview_title' => 'Temos pasikeitimai',
        'template_updated' => 'Temo buvo atnaujinta',
        'template_created' => 'Tema buvo sukurta',
        'template_deleted' => 'Tema buvo ištrinta',
    ],
];
